...
def main():
    ...
    p.add_argument("--exploration", default="eps_greedy", choices=["eps_greedy", "boltzmann", "ucb"])
    ...
    agent = build_agent("dqn", env, cfg, exploration=args.exploration, seed=args.seed)
